...
export function MatchCard({ 
  ...
  return (
    <Card className="overflow-hidden border-[#9b87f5]/20 bg-gradient-to-br from-white to-[#9b87f5]/5 hover:shadow-lg transition-all duration-300">
      <CardHeader className="p-4 bg-gradient-to-r from-[#9b87f5]/10 to-transparent">
