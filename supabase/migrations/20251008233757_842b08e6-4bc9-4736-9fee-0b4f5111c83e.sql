-- =====================================================
-- MIGRACIÓN: Cierre Imprevisto de Canchas (Corregida)
-- =====================================================
...
-- 4. Eliminar políticas existentes si existen y recrearlas
DROP POLICY IF EXISTS "Usuarios pueden ver sus propias reservas afectadas" ON public.affected_bookings;
DROP POLICY IF EXISTS "Sistema puede insertar reservas afectadas" ON public.affected_bookings;
