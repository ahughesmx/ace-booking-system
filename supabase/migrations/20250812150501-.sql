-- Actualizar la función para usar la extensión http correctamente
...
BEGIN
  ...
  -- Obtener datos del jugador registrado y del remitente
  CASE position_changed
    WHEN 'player2' THEN
      registered_player := (match_details.player2_data::jsonb)::record;
      sender_player := (match_details.player1_data::jsonb)::record;
    WHEN 'player1_partner' THEN
      registered_player := (match_details.player1_partner_data::jsonb)::record;
      sender_player := (match_details.player1_data::jsonb)::record;
    WHEN 'player2_partner' THEN
      registered_player := (match_details.player2_partner_data::jsonb)::record;
      sender_player := (match_details.player2_data::jsonb)::record;
  END CASE;
  ...
  webhook_data := jsonb_build_object(
    ...
    END,
    'sender_name', sender_player.full_name,
    'sender_phone', sender_player.phone,
    ...
    END,
    'recipient_name', registered_player.full_name,
    'recipient_phone', registered_player.phone,
    'remotejid', registered_player.phone,
